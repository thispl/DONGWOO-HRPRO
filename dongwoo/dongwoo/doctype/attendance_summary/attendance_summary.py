...
def get_data_mobile(emp, from_date, to_date):
    ...
    data += "<tr style='font-size:5px;padding:1px'><td style = 'border: 2px solid black;background-color:#ADD8E6;padding:1px'><b><center>ID</center></b></td><td style = 'border: 2px solid black;background-color:#ADD8E6;padding:1px'colspan=2><b><center>%s</center></b></td><td style = 'border: 2px solid black;background-color:#ADD8E6;padding:1px'><b><center>Name</center></b></td><td style = 'border: 2px solid black;background-color:#ADD8E6;padding:1px' colspan=2><b><center>%s</center></b></td><td style = 'border: 2px solid black;background-color:#ADD8E6;padding:1px'><b><center>Dept</center></b></td><td style = 'border: 2px solid black;background-color:#ADD8E6;padding:1px' colspan=2><b><center>%s</center></b></td></tr>"%(emp,emp_details[0],emp_details[1])
    ...
    data += "<tr style='font-size:5px;padding:1px'><td style = 'border: 2px solid black;border-right: 1px solid black;background-color:#ADD8E6;padding:1px'><b><center>Date</center></b></td><td style = 'border: 1px solid black;border-bottom: 2px solid black;background-color:#ADD8E6;padding:1px'><b><center>Day</center></b></td><td style = 'border: 1px solid black;border-bottom: 2px solid black;background-color:#ADD8E6;padding:1px'><b><center>Working</center></b></td><td style = 'border: 1px solid black;border-bottom: 2px solid black;background-color:#ADD8E6;padding:1px'><b><center>In Time</center></b></td><td style = 'border: 1px solid black;border-bottom: 2px solid black;background-color:#ADD8E6;padding:1px'><b><center>Out Time</center></b></td><td style = 'border: 2px solid black;border-left: 1px;background-color:#ADD8E6;padding:1px'><b><center>Status</center></b></td><td style = 'border: 1px solid black;border-bottom: 2px solid black;background-color:#ADD8E6;padding:1px'><b><center>Start Time</center></b></td><td style = 'border: 1px solid black;border-bottom: 2px solid black;background-color:#ADD8E6;padding:1px'><b><center>End Time</center></b></td><td style = 'border: 2px solid black;border-left: 1px;background-color:#ADD8E6;padding:1px'><b><center>Total Hrs</center</b></td></tr>"
...
def get_data_system(emp, from_date, to_date):
    ...
    data = "<table class='table table-bordered=1'>"
    data += "<tr><td style = 'border: 1px solid black;background-color:#ADD8E6'><b>ID</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'colspan=2><b>%s</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'><b>Name</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;' colspan=2><b>%s</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'><b>Dept</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;' colspan=2><b>%s</b></td></tr>"%(emp,emp_details[0],emp_details[1])
    ...
    data += "<tr><td style = 'border: 1px solid black;background-color:#ADD8E6'><b>Date</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'><b>Day</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'><b>Working</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'><b>In Time</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'><b>Out Time</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'><b>Status</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'><b>Start Time</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'><b>End Time</b></td><td style = 'border: 1px solid black;background-color:#ADD8E6;'><b>Total Hrs</b></td></tr>"
    ...
    data += "<tr><td colspan=6 style = 'border: 1px solid black;background-color:#ADD8E6;'></td><td colspan=2 style = 'border: 1px solid black;background-color:#ADD8E6;'><center><b>TOTAL</b></center></td><td style = 'border: 1px solid black;background-color:#ADD8E6'><b>%s</b></td></tr>"%(ot)
    data += "<tr><td colspan=4>P - Present<br>A - Absent<br>OL - On Leave</td><td colspan=3>HD - Half Day<br>WFH - Work From Home<br>CO - Compensatory Off</td><td colspan=2>SL - Sick Leave<br>CL - Casual Leave<br>EL - Earned Leave</td></tr>"
    data += "</table>"
    return data
